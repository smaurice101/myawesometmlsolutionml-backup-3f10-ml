[myawesometmlsolutionml-backup-3f10-ml] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-backup-3f10-ml] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-backup-3f10-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   maadsdocker/myawesometmlsolutionml-backup-3f10-ml-amd64 (https://hub.docker.com/r/maadsdocker/myawesometmlsolutionml-backup-3f10-ml-amd64)
...
.. code-block::
   ...
   docker run -d -p 41019:41019 -p 47923:47923 -p 45229:45229 \
          --env TSS=0 \
          --env SOLUTIONNAME=myawesometmlsolutionml-backup-3f10-ml \
          --env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolutionml-backup-3f10 \
          --env GITUSERNAME=smaurice101  \
          --env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \
          --env SOLUTIONEXTERNALPORT=41019 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          -v /your_localmachine/foldername:/rawdata:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=47923 \
          --env SOLUTIONVIPERVIZPORT=45229 \
          ...
          maadsdocker/myawesometmlsolutionml-backup-3f10-ml-amd64
...
[myawesometmlsolutionml-backup-3f10-ml] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-backup-3f10-ml
...
.. important::
   https://myawesometmlsolutionml-backup-3f10-ml.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-myawesometmlsolutionml-backup-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=41019, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39101, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35663, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42621, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42055, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37279, HPDEHOST=127.0.1.1, HPDEPORT=38055, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33261

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4675-myawesometmlsolutionml-backup-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-backup-3f10, python-preprocess-6571-myawesometmlsolutionml-backup-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-backup-3f10, python-ml-5284-myawesometmlsolutionml-backup-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-backup-3f10, python-predict-355-myawesometmlsolutionml-backup-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolutionml-backup-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
